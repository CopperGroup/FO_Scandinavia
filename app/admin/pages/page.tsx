...
import EditorPage from "@/components/admin-components/editor/editor-page"
...
const Page = async () => {
    ...
    <div className="container mx-auto p-4">
      ...
      <div className="flex items-center gap-2">
        ...
        <span className="text-gray-500">This is a span element</span>
      </div>
    </div>
  `
  ...
  const handleSave = (updatedJsx: string) => {
    ...
    // Here you would typically save the JSX to your backend or state
  }

  return (
    <section className="w-full px-5 py-10 pt-3 max-[420px]:px-2">
        <EditorPage initialContent={initialJsx} onSave={handleSave} />
    </section>
  )
}
