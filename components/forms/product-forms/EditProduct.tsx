...
import DeleteProductButton from "@/components/interface/DeleteProductButton";
import CopyButton from "@/components/interface/CopyButton";
import { removeAllButOne, removeExtraLeadingCharacters } from "@/lib/utils";
import { updateCategories } from "@/lib/actions/categories.actions";
...
const EditProduct = ({ stringifiedProduct, categories, stringifiedCategories }: { stringifiedProduct: string, categories: Category[], stringifiedCategories: string }) => {
