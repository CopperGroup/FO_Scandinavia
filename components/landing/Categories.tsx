...
const categories = [
  ...
  },
  {
    ...
    image: "/assets/4.jpg",
    href: "/catalog",
    subcategories: ["Постільна білизна", "Декор", "Домашній текстиль"],
    featured: true,
  },
]
