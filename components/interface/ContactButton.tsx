...
export default function ContactButton() {
  ...
  const fullText = "Зв'язатися з нами"
  ...
  const contactMethods = [
    {
      name: "Telegram",
      phone: contactInfoData ? contactInfoData['Telegram'] : "",
      username: contactInfoData ? contactInfoData['Telegram(nickname)'] : "",
    ...
    {
      name: "Viber",
      phone: contactInfoData ? contactInfoData['Viber'] : "",
